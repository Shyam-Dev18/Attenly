...
- **[Download Attenly APK (v1.1.1)](releases/attenly-v1.1.1.apk)**

_(Note: Go to the GitHub repository's `releases` folder to find the generated APK)._
...
_The output APKs will be located at `build/app/outputs/flutter-apk/`._
